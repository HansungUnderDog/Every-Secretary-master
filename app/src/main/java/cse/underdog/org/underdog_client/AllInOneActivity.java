...
import cse.underdog.org.underdog_client.selectcalendars.SelectVisibleCalendarsFragment;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.ic_center_focus:
                        Intent intent3 = new Intent(AllInOneActivity.this, MemoActivity.class);
                        startActivity(intent3);
                        break;

                    case R.id.ic_backup:
                        Intent intent4 = new Intent(AllInOneActivity.this, EtcActivity.class);

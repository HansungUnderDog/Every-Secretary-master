                ...
                builder
                        ...
                        .setPositiveButton(getString(R.string.yes), new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                System.out.println("id뭐여" + getIntent().getExtras().getInt(getString(R.string.rodID).toString()));
                                /*db.delete(DbHelper.TABLE_NAME, DbHelper.C_ID + "=" + id, null);
                                db.close();*/
                                Intent openMainActivity = new Intent(View_Note.this, MemoActivity.class);
                                startActivity(openMainActivity);
